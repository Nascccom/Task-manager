...
beforeEach(() => {
    startState = {
        ['todolistID1']: [
            {
                ...
                status: TaskStatuses.New, priority: TaskPriorities.Hi, startDate: '',
                deadline: '', todoListId: 'todolistID1', order: 0, addedDate: ''
            },
            {
                id: '2', title: 'JS', completed: true, description: '',
                status: TaskStatuses.New, priority: TaskPriorities.Hi, startDate: '',
                deadline: '', todoListId: 'todolistID1', order: 0, addedDate: ''
            },
        ],
        ['todolistID2']: [
            {
                id: '3', title: 'React', completed: true, description: '',
                status: TaskStatuses.New, priority: TaskPriorities.Hi, startDate: '',
                deadline: '', todoListId: 'todolistID2', order: 0, addedDate: ''
            },
            {
                id: '4', title: 'RTK', completed: true, description: '',
                status: TaskStatuses.New, priority: TaskPriorities.Hi, startDate: '',
                deadline: '', todoListId: 'todolistID2', order: 0, addedDate: ''
            },
        ]
...
test('correct task should be changed tittle', () => {
    ...
    if (necessaryTask) {
        ...
        const action = updateTaskAC({todolistId: 'todolistID1', taskId: '1', task: necessaryTask})
        const endState: TasksStateType = tasksReducer(startState, action);
